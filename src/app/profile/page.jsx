    ...
    <>
      ...
      <main className="bg-gray-100 min-h-screen pt-20">
        ...
        <div className="bg-white border border-gray-200 rounded-lg lg:w-[700px] m-auto w-[95%] p-10">
          ...
          <div className="mt-5">
            <div className="flex gap-8 bg-gray-100 w-[240px] rounded-md p-1 justify-center text-gray-500">
                    ...
                    <form onSubmit={handleGeneralSubmit}>
                      <div className="flex gap-5">
                        <div>
                          ...
                          <input
                            className="p-2 text-base sm:text-lg pr-3 py-2 border-2 border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"
