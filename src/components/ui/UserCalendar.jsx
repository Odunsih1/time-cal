        ...
        <Tabs defaultValue="calendar" className="w-full">
          ...
          <TabsContent value="calendar" className="mt-6">
            <div className="space-y-6">
                ...
                <AnimatePresence mode="wait" custom={direction}>
                  ...
                  >
                    <ShadcnCalendar
                      ...
                      month={currentMonth}
                      onMonthChange={setCurrentMonth} // Keep sync if internal nav is used (though hidden)
                      className="rounded-md border shadow-sm w-full h-full flex"
                      classNames={{
                        months:
              ...
              {selectedDate && (
                <div className="bg-slate-50 border-2 border-slate-200 rounded-xl p-6 animate-in slide-in-from-top-4 duration-300">
